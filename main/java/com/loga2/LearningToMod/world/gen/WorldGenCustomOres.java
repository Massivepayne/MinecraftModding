package com.loga2.LearningToMod.world.gen;

import java.util.Random;

import com.loga2.LearningToMod.init.BlockOres;
import com.loga2.LearningToMod.init.ModBlocks;
import com.loga2.LearningToMod.util.handlers.EnumHandler;
...
public class WorldGenCustomOres implements IWorldGenerator
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider)
	{
		...
		case 0:
			...
			runGenerator(ore_overworld_copper, world, random, chunkX, chunkZ, 10, 12, 50);
